...
void main(){
  group('Mock Authentication', (){
    final provider = MockAuthPrivider();
    ...
    test('Create user delegates to logIn', () async {
  ...
  test('Should be able to log out nad log in again',()async{
...
class MockAuthPrivider implements AuthProvider {
  AuthUser? _user;
